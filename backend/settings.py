...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', EMAIL_HOST_USER or 'no-reply@fass.app').strip()
...
STRIPE_CURRENCY = os.getenv('STRIPE_CURRENCY', 'aed').strip().lower() or 'aed'
PLATFORM_FEE_PERCENT = os.getenv('PLATFORM_FEE_PERCENT', '5').strip() or '5'
